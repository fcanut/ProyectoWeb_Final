...
<div class="header"></div>
    ...
    // Convertir la fecha a un formato legible si es necesario
        ...
        <form id="registro-reservacion" action="http://localhost:8081/adventure-master/registar_reservacion.php" method="post">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fecha_evento" name="fecha_evento" value="<?php echo $fechaSeleccionada; ?>" required>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                    <input type="hidden" name="color_evento" id="color_evento" value="#FF5722">
                    </div>
                </div>
                ...
                <div class="col-md-12" id="grupoRadio">
                        ...
                        <input type="radio" name="color_evento" id="amber" value="#FFC107" checked>  
                        <label for="amber" class="circu" style="background-color: #FFC107;"> </label>

                        <input type="radio" name="color_evento" id="lime" value="#8BC34A" checked>  
                        <label for="lime" class="circu" style="background-color: #8BC34A;"> </label>

                        <input type="radio" name="color_evento" id="teal" value="#009688" checked>  
                        <label for="teal" class="circu" style="background-color: #009688;"> </label>

                        <input type="radio" name="color_evento" id="blue" value="#2196F3" checked>  
                        <label for="blue" class="circu" style="background-color: #2196F3;"> </label>

                        <input type="radio" name="color_evento" id="indigo" value="#9c27b0" checked>  
